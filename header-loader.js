...
(function() {
    ...
    // 2. Inject CSS for Hover States and Menu Layout
    const style = document.createElement('style');
    style.innerHTML = `
        /* Ensures the dropdown links look like the main blog */
        #nav-trigger a { 
            display: block; 
            padding: 10px 15px; 
    ...
    // 3. Header HTML with Mobile Menu Structure
    const headerHTML = `
