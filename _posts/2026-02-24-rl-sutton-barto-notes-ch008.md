...
- <u>Expected update:</u> error $= 0$ after one update (cost: $\sim b$ units).
- <u>Sample updates (assuming sample averages, i.e. $\alpha = \frac{1}{t}$):</u> error $\approx \sqrt{\frac{b-1}{bt}}$.
