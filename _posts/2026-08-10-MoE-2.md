...
## **Table of Contents**
- [Feed-Forward Networks in Transformers](#feed-forward-networks-in-transformerss)
...
- [Fine-Grained Experts](#finegrained-experts)
...
- [The Load Balancing Problem](#the-load-balancing-problem)
  ...
  - [Device-Level Load Balancing](#devicelevel-load-balancing)
- [Loss-Free Load Balancing](#loss-free-load-balancing)
- [Auxiliary-Loss-Free Load Balancing](#auxiliarylossfree-load-balancing)
- [Router Stability & the Router Z-Loss](#router-stability--the-router-zloss)
